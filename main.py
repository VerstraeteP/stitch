...
def start(video):
	...
	stitched_image,affinetransformation,renners,fps_scaled,fps,mask=prepare_data_and_stitch(frame_list,fps)
	...
	solution,renner=calculate_pos(renners,affinetransformation,args.renners,stitched,fps_scaled,fps)
